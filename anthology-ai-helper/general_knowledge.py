...
IMPORTANT_PREFIXES = (
    ...
    "профил", "mo2", "hard", "хард", "стандарт", "правил", "бан", "модер", "админ",
    "mcm", "wpo", "лцу", "лазер", "подстволь", "миникарт", "компас", "патрон",
    "магазин", "mags", "redux", "прицел", "scopes", "клин", "bhs", "dx11", "фпс", "fps",
)
